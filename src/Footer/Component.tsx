    ...
    <footer className="w-full border-t bg-white py-6 md:py-8">
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            <h3 className="text-lg font-medium mb-3 text-rose-800">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-medium mb-3 text-rose-800">Contact</h3>
      ...
      <div className="mt-8 border-t pt-6 text-center text-sm text-gray-600">
        <p>© {new Date().getFullYear()} Beecreative. All rights reserved.</p>
      </div>
    </footer>
  )
}
